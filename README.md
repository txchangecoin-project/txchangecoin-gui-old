...
**Untraceability:** By taking advantage of ring signatures, a special property of a certain type of cryptography, Txchangecoin is able to ensure that transactions are not only untraceable, but have an optional measure of ambiguity that ensures that transactions cannot easily be tied back to an individual user or computer.

## About this project

This is the GUI for the [core Txchangecoin implementation](https://github.com/txchangecoin-project/txchangecoin). It is open source and completely free to use without restrictions, except for those specified in the license agreement below. There are no restrictions on anyone creating an alternative implementation of Txchangecoin that uses the protocol and network in a compatible manner.
...
## Installing the Txchangecoin GUI from a package
...
## Compiling the Txchangecoin GUI from source

### On Linux:

(Tested on Ubuntu 17.10 x64, Ubuntu 18.04 x64 and Gentoo x64)

1. Install Txchangecoin dependencies
...
The Txchangecoin GUI on Windows is 64 bits only; 32-bit Windows GUI builds are not officially supported anymore.

1. Install [MSYS2](https://www.msys2.org/), follow the instructions on that page on how to update system and packages to the latest versions

2. Open an 64-bit MSYS2 shell: Use the *MSYS2 MinGW 64-bit* shortcut, or use the `msys2_shell.cmd` batch file with a `-mingw64` parameter

3. Install MSYS2 packages for Txchangecoin dependencies; the needed 64-bit packages have `x86_64` in their names
    ...
    You find more details about those dependencies in the [Txchangecoin documentation](https://github.com/txchangecoin-project/txchangecoin). Note that that there is no more need to compile Boost from source; like everything else, you can install it now with a MSYS2 package.
