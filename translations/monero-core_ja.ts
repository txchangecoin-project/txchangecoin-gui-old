...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、txchangecoincoinのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しtxchangecoincoinを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>あなたのコンピュータでマイニングを行うことで、txchangecoincoinのネットワークをより強固にすることができます。マイニングをする人が増えるほど、ネットワークへの攻撃が難しくなります。一人一人の協力が大切です。&lt;br&gt; &lt;br&gt;マイニングをすると、低確率ですがtxchangecoincoinを獲得できる可能性があります。あなたのコンピュータは、ある計算問題の解となるブロックとそのハッシュ値を計算します。正解のブロックが見つかると、あなたはそれに伴う報酬を得ます。グッドラック!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているtxchangecoincoinのバージョン: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってtxchangecoincoinネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;txchangecoincoin remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはtxchangecoincoinウォレットおよびtxchangecoincoinのキーを再利用するtxchangecoincoinクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、txchangecoincoinトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、txchangecoincoinが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはtxchangecoincoinプロジェクトによって保守されtxchangecoin.onlineのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはtxchangecoin-blockchain-mark-spent-outputsというツールを使い、txchangecoincoinのブロックチェーン(およびキーを再利用するtxchangecoincoinクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>txchangecoincoinのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するtxchangecoincoinクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するtxchangecoincoinクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されtxchangecoincoinを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するtxchangecoincoinクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためtxchangecoincoinでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoinアドレス (例: TXCHQt9JNCvTcN...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoinの送金に成功しました</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoinネットワークとやりとりするにはウォレットをtxchangecoincoinノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoinをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoinへようこそ。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>もしtxchangecoincoinを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいtxchangecoincoinウォレットを作成</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>(&lt;i&gt;ブートストラップ&lt;/i&gt;という名前が示すように)リモートノードを一時的に使用することはtxchangecoincoinをすぐに使うのに便利です。ただしリモートノードを使う場合(ブートストラップ設定時を含む)、ノードはあなたのIPアドレスや&quot;復元を開始するブロック高&quot;とそれに付随するブロック要求データを追跡でき、あなたが送る取引についてより知るために正確でない情報を送ってくる可能性があります。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のtxchangecoincoinを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。txchangecoincoinネットワークに自動的に接続するためtxchangecoincoinをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>txchangecoincoinネットワークとやりとりするためウォレットはtxchangecoincoinノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
...
金額: </translation>
    ...
    <message>
        ...
        <translation>このアドレスは%1TXXを受け取りましたが、取引はまだ承認されていません。</translation>
    </message>
    <message>
        <location filename="../main.qml" line="913"/>
        <source>This address received %1 txchangecoin, with %2 confirmation(s).</source>
        <translation>このアドレスは%1TXXを受け取り、その取引は%2回承認されました。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>新しいバージョンのtxchangecoin-wallet-guiを入手できます: %1&lt;br&gt;%2</translation>
    </message>
    <message>
...
手数料: </translation>
    ...
    <message>
        ...
        <translation>txchangecoincoinの送金に成功しました: %1 トランザクション</translation>
    </message>
    <message>
