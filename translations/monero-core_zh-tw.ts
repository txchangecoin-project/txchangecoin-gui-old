...
<context>
    ...
    <message>
        ...
        <translation>警告: 複製您的種子碼到剪貼簿有可能會讓它被惡意軟體側錄，並竊取您的 txchangecoincoin，請用紙筆抄寫下來。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>挖礦可增進 txchangecoincoin 網路的安全性，只要越多使用者在挖礦，txchangecoincoin 網路就會越難以被攻擊。&lt;br&gt; &lt;br&gt;挖礦也同時提供您機會賺取一些額外的 txchangecoincoin 幣，因為在挖礦時，您的電腦將被用來尋找 txchangecoincoin 區塊的解答，每當您找到一個區塊的解答，您即可以獲得其附帶的獎勵金，祝您好運！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>內嵌 txchangecoincoin 版本: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用第三方的遠端節點以連接到 txchangecoincoin 網路，較不安全，但簡易使用。</translation>
    </message>
    <message>
        ...
        <translation>如果需要遠端節點，上網搜尋「 txchangecoincoin 遠端節點 」。請確認該節點是由可信任的第三方所架設。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>本頁面可以讓你對共享環簽資料庫進行操作，這個資料庫可以讓 txchangecoincoin 錢包與其重複使用金鑰的分叉幣錢包共享環簽資訊。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了要混淆 txchangecoincoin 真實被花用過的交易輸入，第三方不應能得知在環簽內的交易組合中哪一個交易是已經被花用的，否則環簽的保護效果將被減弱。若被觀察出只有一個交易輸出是尚未被花用的則該筆交易的來源將會變得顯而易見，也就等於損失了 txchangecoincoin 的三大保護隱私保護其中之一: 環狀簽名。&lt;br&gt;若要避免發生這類狀況，一個已知被花用的交易輸出名單可以用來避免在新的交易中使用到這些輸出，此份名單是由 txchangecoincoin 專案所維護，可以在 txchangecoin.online 網站上找到並在此匯入。&lt;br&gt;或是你可以選擇使用 txchangecoin-blockchain-mark-spent-outputs tool 自行掃描區塊鏈(與重複使用金鑰的分叉幣區塊鏈)以產生該份名單。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>為了避免讓 txchangecoincoin 的環狀簽名保護失效，一個交易輸出應避免在不同的區塊鏈中以不同的環簽組合所花用。這通常不需要擔心，但當你在重複使用金鑰的分叉幣區塊鏈上花用現有的交易輸出時就得注意，必需在兩條鏈上使用相同的環簽組合。&lt;br&gt;這個保護措施在txchangecoincoin或其他注重保護你的隱私的軟體中重複使用金鑰時都應是自動完成的。&lt;br&gt;如果你正在使用重複使用金鑰的分叉幣且該幣並未包含此保護措施，你必須先於分叉幣上花用交易，再將環簽在此匯入以確保您的txchangecoincoin交易隱私安全。&lt;br&gt;若你沒有使用未經保護的分叉幣則不須任何處置，因為這保護措施將會自動完成。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>這記錄著在 txchangecoincoin 鏈上所使用過的環狀簽名組合，因此相同組合應在重複金鑰的分叉鏈上沿用以確保隱私安全。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>輸入 txchangecoincoin 位址 (範例: TXCHQt9JNCvTcN...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoin 發送成功</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>為了在 txchangecoincoin 網路上交易，您必須先連接至一個 txchangecoincoin 節點。為了獲得最好的隱私保護，建議您自行運作一個節點。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>此外，你或許會想要指定一個引導節點以馬上使用 txchangecoincoin。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>歡迎使用 txchangecoincoin。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>如果您是初次使用 txchangecoincoin 請選此項。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>連接您的硬體錢包以建立一個新的 txchangecoincoin 錢包。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>雖然暫時使用遠端節點讓您可以立刻開始使用 txchangecoincoin (因此稱為&lt;i&gt;引導&lt;/i&gt;)，但是請注意當您使用遠端節點時 (包括引導節點)，節點可能會記錄您的 IP 位址、回復區塊高度、相關區塊資料、甚至發送錯誤資訊以獲取更多關於你的交易資訊。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>這個模式適合小金額的 txchangecoincoin 交易，您將會有基本的交易發送及管理功能，錢包將會自動連接至 txchangecoincoin 網路讓您可以立即開始使用錢包。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>為了在 txchangecoincoin 網路上交易，您必須先連接至一個 txchangecoincoin 節點。為了獲得最好的隱私保護，建議您自行運作一個節點。
...
轉出位址索引: </translation>
    ...
    <message>
        ...
        <translation>txchangecoincoin發送成功: %1 筆交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>這個位址收入了 %1 txchangecoin，並通過 %2 次的確認。</translation>
    </message>
    <message>
        <location filename="../main.qml" line="924"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>有可用的新版本 txchangecoincoin 錢包: %1&lt;br&gt;%2</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>這個位址已收到 %1 txchangecoincoin 幣，但這筆交易尚未被礦工確認</translation>
    </message>
    <message>
