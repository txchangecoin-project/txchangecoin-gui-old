...
<context>
    ...
    <message>
        ...
        <translation>ПОПЕРЕДЖЕННЯ: Не використовуйте повторно свої ключі txchangecoincoin в іншому форку, ЯКЩО ТІЛЬКИ цей форк не має вбудованих засобів захисту від компрометації введених ключів. Подібні дії можуть зашкодити вашій конфіденційності.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія txchangecoincoin: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Використовувати сторонній вузол для підключення до мережі txchangecoincoin. Менш безпечно, але більш зручно.</translation>
    </message>
    <message>
        ...
        <translation>Щоб отримати список віддалених нод, введіть &apos;txchangecoincoin remote node&apos; у вашій улюбленій пошуковій системі. Будь ласка, переконайтеся, що обраній ноді можна довіряти.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями txchangecoincoin або їх клонів, які зможуть повторно використовувати ключі txchangecoincoin.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях txchangecoincoin були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності txchangecoincoin.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом txchangecoincoin і доступний на веб-сайті txchangecoin.online, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів txchangecoincoin) самостійно, використовуючи інструмент txchangecoin-blockchain-mark-spent-outputs, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами txchangecoincoin, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон txchangecoincoin, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон txchangecoincoin з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші txchangecoincoin.&lt;br&gt;Якщо ви не використовуєте клон txchangecoincoin з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на txchangecoincoin, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>txchangecoincoin відправлено успішно</translation>
    </message>
    <message>
...
Індекс адреса витрати: </translation>
    ...
    <message>
        ...
        <translation>txchangecoincoin успішно відправлені: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TXX, із %2 підтвердженнями(и)</translation>
    </message>
    <message>
        <location filename="../main.qml" line="924"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TXX, але транзакція ще не була підтверджена майнерами</translation>
    </message>
    <message>
