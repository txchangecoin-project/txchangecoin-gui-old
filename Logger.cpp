...
static const QString defaultLogName = "txchangecoin-wallet-gui.log";
#if defined(Q_OS_IOS)
    ...
    static const QString appFolder = "txchangecoin-wallet-gui";
    ...
    //HomeLocation = "~"
    static const QString osPath = QStandardPaths::standardLocations(QStandardPaths::HomeLocation).at(0);
    static const QString appFolder = ".txchangecoin";
#endif
